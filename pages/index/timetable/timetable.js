...
Page({
    ...
    */
    setShrinkKCBData() {
        let temp = storage.get("shrinkKCB", null) || null;
        if (temp !== null) {
            this.setData({
                shrinkKCB: temp
            });
        ...
        let kbcopy = storage.get("timetable", []).slice();
        ...
        storage.put("shrinkKCB", shrinkKCB, 24 * 60 * 60);
    ...
    */
    setSameColor() {
        ...
        let ids = [];
        let kbcopy = storage.get("timetable", []).slice(); // 原有课程
        ...
        storage.put("colorObj", colorObj, 24 * 60 * 60);
        this.setData({
            colorObj
        })
    },
    ...
    */
    getTermDay() {
        ...
        storage.put("wholeSemesterDays", wholeSemesterDays, 24 * 60 * 60)
    },
    ...
    */
    getDateStr(AddDayCount) {
        ...
        let openDate = storage.get("openDate") || 1566777600000; // 2019-07-28
    ...
    */
    getInfo() {
        let currentWeek = storage.get("currWeek", 1);
        this.setData({
